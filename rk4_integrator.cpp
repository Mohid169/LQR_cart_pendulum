...
// Step 1
double k1_theta_dot = system.calculatePendulumVelocity(system.getThetaDot());
double k1_theta_accel = system.calculateThetaAcceleration(system.getPendulumAngle(), system.getThetaDot(), system.calculateCartAcceleration(controlForce, system.getPendulumAngle(), system.getThetaDot(), system.getCartPosition(), system.getCartVelocity()));
double k1_x_dot = system.calculateCartAcceleration(controlForce, system.getPendulumAngle(), system.getThetaDot(), system.getCartPosition(), system.getCartVelocity());
double k1_x_accel = system.calculateCartAcceleration(controlForce, system.getPendulumAngle(), system.getThetaDot(), system.getCartPosition(), system.getCartVelocity());

// Step 2
double k2_theta_dot = system.calculatePendulumVelocity(system.getThetaDot() + k1_theta_accel * dt / 2.0);
...
// Step 3
double k3_theta_dot = system.calculatePendulumVelocity(system.getThetaDot() + k2_theta_accel * dt / 2.0);
...
// Step 4
double k4_theta_dot = system.calculatePendulumVelocity(system.getThetaDot() + k3_theta_accel * dt);
